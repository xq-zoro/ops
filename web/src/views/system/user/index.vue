<template>
  <d2-container :class="{ 'page-compact': crud.pageOptions.compact }">
    <d2-crud-x ref="d2Crud" v-bind="_crudProps" v-on="_crudListeners" @resetPassword="resetPassword">
      <div slot="header">
        ...
        <el-button-group>
          ...
          <importExcel importApi="api/system/user/import/" v-permission="'Import'">导入</importExcel>
        </el-button-group>
    ...
    <el-dialog title="密码重置" :visible.sync="dialogFormVisible" :close-on-click-modal="false" width="30%">
